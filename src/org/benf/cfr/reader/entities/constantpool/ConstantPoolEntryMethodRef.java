...
public class ConstantPoolEntryMethodRef extends AbstractConstantPoolEntry {
    ...
    public MethodPrototype getMethodPrototype() {
        if (methodPrototype == null) {
            ...
            MethodPrototype basePrototype = ConstantPoolUtils.parseJavaMethodPrototype(cp.getDCCommonState(),null, classType, getName(), /* interfaceMethod */ false, Method.MethodConstructor.NOT, descriptor, cp, false /* we can't tell */, false, fakeNamer);
