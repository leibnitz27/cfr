...
public enum JVMInstr {
    ...
    IF_ICMPGT(0xa1, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, new OperationFactoryConditionalJump()),
    IF_ICMPGE(0xa2, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, new OperationFactoryConditionalJump()),
    IF_ICMPLT(0xa3, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, new OperationFactoryConditionalJump()),
