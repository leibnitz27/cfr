...
public enum JVMInstr {
    ...
    FCONST_0(0xb, 0, StackTypes.EMPTY, StackType.FLOAT.asList(), RawJavaType.FLOAT),
    ...
    I2B(0x91, 0, StackType.INT.asList(), StackType.INT.asList(), null),
    ...
    I2L(0x85, 0, StackType.INT.asList(), StackType.LONG.asList(), RawJavaType.LONG),
    ...
    ICONST_M1(0x2, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ICONST_0(0x3, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ICONST_1(0x4, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ICONST_2(0x5, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ICONST_3(0x6, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ICONST_4(0x7, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ICONST_5(0x8, 0, StackTypes.EMPTY, StackType.INT.asList(), RawJavaType.INT),
    ...
    IF_ICMPEQ(0x9f, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IF_ICMPNE(0xa0, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IF_ICMPLT(0xa1, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IF_ICMPGE(0xa2, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IF_ICMPGT(0xa3, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IF_ICMPLE(0xa4, 2, new StackTypes(StackType.INT, StackType.INT), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IFEQ(0x99, 2, StackType.INT.asList(), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IFNE(0x9a, 2, StackType.INT.asList(), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    IFLT(0x9b, 2, StackType.INT.asList(), StackTypes.EMPTY, RawJavaType.VOID, new OperationFactoryConditionalJump()),
    ...
    L2I(0x88, 0, StackType.LONG.asList(), StackType.INT.asList(), RawJavaType.INT),
    LADD(0x61, 0, new StackTypes(StackType.LONG, StackType.LONG), StackType.LONG.asList(), RawJavaType.LONG),
    ...
    LCMP(0x94, 0, new StackTypes(StackType.LONG, StackType.LONG), StackType.INT.asList(), RawJavaType.INT),
    LCONST_0(0x9, 0, StackTypes.EMPTY, StackType.LONG.asList(), RawJavaType.LONG),
    LCONST_1(0xa, 0, StackTypes.EMPTY, StackType.LONG.asList(), RawJavaType.LONG),
    LDC(0x12, 1, null, null, null, new OperationFactoryLDC()),
