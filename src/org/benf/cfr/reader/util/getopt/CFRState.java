...
public class CFRState {
    ...
    public static final PermittedOptionProvider.Argument<Boolean, CFRState> SUGAR_PRIMITIVES = new PermittedOptionProvider.Argument<Boolean, CFRState>(
            "sugarprimitives", defaultTrueBooleanDecoder);
    ...
    private static class CFRFactory implements GetOptSinkFactory<CFRState> {
        ...
        public List<? extends Argument<?, ?>> getArguments() {
            return ListFactory.newList(SHOWOPS, ENUM_SWITCH, ENUM_SUGAR, STRING_SWITCH, ARRAY_ITERATOR,
                    ...
                    REMOVE_DEAD_METHODS, REMOVE_BAD_GENERICS, SUGAR_ASSERTS, SUGAR_PRIMITIVES, SHOW_CFR_VERSION);
        }
