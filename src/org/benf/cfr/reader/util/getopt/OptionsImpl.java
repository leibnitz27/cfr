...
public class OptionsImpl implements Options {
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> SUGAR_STRINGBUFFER = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> SUGAR_STRINGBUILDER = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> SUGAR_STRINGCONCATFACTORY = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> ENUM_SWITCH = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> ENUM_SUGAR = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> STRING_SWITCH = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> PREVIEW_FEATURES = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> SWITCH_EXPRESSION = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> RECORD_TYPES = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "recordtypes", recordTypesVersion,
            "Re-sugar record types");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> INSTANCEOF_PATTERN = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "instanceofpattern", recordTypesVersion,
            "Re-sugar instanceof pattern matches");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> ARRAY_ITERATOR = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "arrayiter", new VersionSpecificDefaulter(ClassFileVersion.JAVA_5, true),
            "Re-sugar array based iteration");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> COLLECTION_ITERATOR = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "collectioniter", new VersionSpecificDefaulter(ClassFileVersion.JAVA_5, true),
            "Re-sugar collection based iteration");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> REWRITE_TRY_RESOURCES = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "tryresources", new VersionSpecificDefaulter(ClassFileVersion.JAVA_7, true),
            "Reconstruct try-with-resources");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> REWRITE_LAMBDAS = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "decodelambdas", new VersionSpecificDefaulter(ClassFileVersion.JAVA_8, true),
            "Re-build lambda functions");
    public static final PermittedOptionProvider.Argument<Boolean> DECOMPILE_INNER_CLASSES = new PermittedOptionProvider.Argument<Boolean>(all,
            "innerclasses", defaultTrueBooleanDecoder,
            "Decompile inner classes");
    public static final PermittedOptionProvider.Argument<Boolean> SKIP_BATCH_INNER_CLASSES = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> HIDE_UTF8 = new PermittedOptionProvider.Argument<Boolean>(all,
            "hideutf", defaultTrueBooleanDecoder,
            "Hide UTF8 characters - quote them instead of showing the raw characters");
    public static final PermittedOptionProvider.Argument<Boolean> HIDE_LONGSTRINGS = new PermittedOptionProvider.Argument<Boolean>(all,
            "hidelongstrings", defaultFalseBooleanDecoder,
            "Hide very long strings - useful if obfuscators have placed fake code in strings");
    public static final PermittedOptionProvider.Argument<Boolean> REMOVE_BOILERPLATE = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> REMOVE_INNER_CLASS_SYNTHETICS = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> HIDE_BRIDGE_METHODS = new PermittedOptionProvider.Argument<Boolean>(all,
            "hidebridgemethods", defaultTrueBooleanDecoder,
            "Hide bridge methods");
    public static final PermittedOptionProvider.Argument<Boolean> RELINK_CONSTANT_STRINGS = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> LIFT_CONSTRUCTOR_INIT = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> REMOVE_DEAD_METHODS = new PermittedOptionProvider.Argument<Boolean>(all,
            "removedeadmethods", defaultTrueBooleanDecoder,
            "Remove pointless methods - default constructor etc.");
    public static final PermittedOptionProvider.Argument<Boolean> REMOVE_BAD_GENERICS = new PermittedOptionProvider.Argument<Boolean>(all,
            "removebadgenerics", defaultTrueBooleanDecoder,
            "Hide generics where we've obviously got it wrong, and fallback to non-generic");
    public static final PermittedOptionProvider.Argument<Boolean> SUGAR_ASSERTS = new PermittedOptionProvider.Argument<Boolean>(all,
            "sugarasserts", defaultTrueBooleanDecoder,
            "Re-sugar assert calls");
    public static final PermittedOptionProvider.Argument<Boolean> SUGAR_BOXING = new PermittedOptionProvider.Argument<Boolean>(all,
            "sugarboxing", defaultTrueBooleanDecoder,
            "Where possible, remove pointless boxing wrappers");
    public static final PermittedOptionProvider.Argument<Boolean> SHOW_CFR_VERSION = new PermittedOptionProvider.Argument<Boolean>(all,
            "showversion", defaultTrueBooleanDecoder,
            "Show used CFR version in header (handy to turn off when regression testing)");
    public static final PermittedOptionProvider.Argument<Boolean> DECODE_FINALLY = new PermittedOptionProvider.Argument<Boolean>(all,
            "decodefinally", defaultTrueBooleanDecoder,
            "Re-sugar finally statements");
    public static final PermittedOptionProvider.Argument<Boolean> TIDY_MONITORS = new PermittedOptionProvider.Argument<Boolean>(all,
            "tidymonitors", defaultTrueBooleanDecoder,
            "Remove support code for monitors - e.g. catch blocks just to exit a monitor");
    public static final PermittedOptionProvider.Argument<Boolean> COMMENT_MONITORS = new PermittedOptionProvider.Argument<Boolean>(all,
            "commentmonitors", defaultFalseBooleanDecoder,
            "Replace monitors with comments - useful if we're completely confused");
    public static final PermittedOptionProvider.Argument<Boolean> LENIENT = new PermittedOptionProvider.Argument<Boolean>(all,
            "lenient", defaultFalseBooleanDecoder,
            "Be a bit more lenient in situations where we'd normally throw an exception");
    public static final PermittedOptionProvider.Argument<Boolean> DUMP_CLASS_PATH = new PermittedOptionProvider.Argument<Boolean>(all,
            "dumpclasspath", defaultFalseBooleanDecoder,
            "Dump class path for debugging purposes");
    public static final PermittedOptionProvider.Argument<Boolean> DECOMPILER_COMMENTS = new PermittedOptionProvider.Argument<Boolean>(all,
            "comments", defaultTrueBooleanDecoder,
            "Output comments describing decompiler status, fallback flags etc.");
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_TOPSORT = new PermittedOptionProvider.Argument<Troolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<ClassFileVersion> FORCE_CLASSFILEVER = new PermittedOptionProvider.Argument<ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.Argument<Troolean> FOR_LOOP_CAPTURE = new PermittedOptionProvider.Argument<Troolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_TOPSORT_EXTRA = new PermittedOptionProvider.Argument<Troolean>(all,
            "forcetopsortaggress", defaultNeitherTrooleanDecoder,
            "Force extra aggressive topsort options");
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_TOPSORT_NOPULL = new PermittedOptionProvider.Argument<Troolean>(all,
            "forcetopsortnopull", defaultNeitherTrooleanDecoder,
            "Force topsort not to pull try blocks");
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_COND_PROPAGATE = new PermittedOptionProvider.Argument<Troolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_RETURNING_IFS = new PermittedOptionProvider.Argument<Troolean>(all,
            "forcereturningifs", defaultNeitherTrooleanDecoder,
            "Move return up to jump site");
    public static final PermittedOptionProvider.Argument<Boolean> IGNORE_EXCEPTIONS_ALWAYS = new PermittedOptionProvider.Argument<Boolean>(all,
            "ignoreexceptionsalways", defaultFalseBooleanDecoder,
            "Drop exception information (WARNING : changes semantics, dangerous!)");
    public static final PermittedOptionProvider.Argument<Boolean> IGNORE_EXCEPTIONS = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_PRUNE_EXCEPTIONS = new PermittedOptionProvider.Argument<Troolean>(all,
            "forceexceptionprune", defaultNeitherTrooleanDecoder,
            "Remove nested exception handlers if they don't change semantics");
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_AGGRESSIVE_EXCEPTION_AGG = new PermittedOptionProvider.Argument<Troolean>(all,
            "aexagg", defaultNeitherTrooleanDecoder,
            "Try to extend and merge exceptions more aggressively");
    public static final PermittedOptionProvider.Argument<Troolean> FORCE_AGGRESSIVE_EXCEPTION_AGG2 = new PermittedOptionProvider.Argument<Troolean>(all,
            "aexagg2", defaultNeitherTrooleanDecoder,
            "Try to extend and merge exceptions more aggressively (may change semantics)");
    public static final PermittedOptionProvider.Argument<Troolean> RECOVER_TYPECLASHES = new PermittedOptionProvider.Argument<Troolean>(all,
            "recovertypeclash", defaultNeitherTrooleanDecoder,
            "Split lifetimes where analysis caused type clash");
    public static final PermittedOptionProvider.Argument<Troolean> USE_RECOVERED_ITERATOR_TYPE_HINTS = new PermittedOptionProvider.Argument<Troolean>(all,
            "recovertypehints", defaultNeitherTrooleanDecoder,
            "Recover type hints for iterators from first pass");
    public static final PermittedOptionProvider.Argument<String> OUTPUT_DIR = new PermittedOptionProvider.Argument<String>(all,
            "outputdir", defaultNullStringDecoder,
            "Decompile to files in [directory] (= options 'outputpath' + 'clobber') (historic compatibility)");
    public static final PermittedOptionProvider.Argument<String> OUTPUT_PATH = new PermittedOptionProvider.Argument<String>(all,
            "outputpath", defaultNullStringDecoder,
            "Decompile to files in [directory]");
    public static final PermittedOptionProvider.Argument<Troolean> CLOBBER_FILES = new PermittedOptionProvider.Argument<Troolean>(all,
            "clobber", defaultNeitherTrooleanDecoder,
            "Overwrite files when using option 'outputpath'");
    public static final PermittedOptionProvider.Argument<Boolean> SILENT = new PermittedOptionProvider.Argument<Boolean>(all,
            "silent", defaultFalseBooleanDecoder,
            "Don't display state while decompiling");
    public static final PermittedOptionProvider.Argument<Boolean> RECOVER = new PermittedOptionProvider.Argument<Boolean>(all,
            "recover", defaultTrueBooleanDecoder,
            "Allow more and more aggressive options to be set if decompilation fails");
    public static final PermittedOptionProvider.Argument<Boolean> ECLIPSE = new PermittedOptionProvider.Argument<Boolean>(all,
            "eclipse", defaultTrueBooleanDecoder,
            "Enable transformations to handle Eclipse code better");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> OVERRIDES = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> SHOW_INFERRABLE = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
    ...
    public static final PermittedOptionProvider.Argument<String> HELP = new PermittedOptionProvider.Argument<String>(all,
            "help", defaultNullStringDecoder,
            "Show help for a given parameter");
    public static final PermittedOptionProvider.Argument<Boolean> ALLOW_CORRECTING = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> LABELLED_BLOCKS = new PermittedOptionProvider.Argument<Boolean>(all,
            "labelledblocks", defaultTrueBooleanDecoder,
            "Allow code to be emitted which uses labelled blocks, (handling odd forward gotos)");
    public static final PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion> JAVA_4_CLASS_OBJECTS = new PermittedOptionProvider.ArgumentParam<Boolean, ClassFileVersion>(all,
            "j14classobj", new VersionSpecificDefaulter(ClassFileVersion.JAVA_5, false),
            "Reverse java 1.4 class object construction");
    public static final PermittedOptionProvider.Argument<Boolean> HIDE_LANG_IMPORTS = new PermittedOptionProvider.Argument<Boolean>(all,
            "hidelangimports", defaultTrueBooleanDecoder,
            "Hide imports from java.lang.");
    public static final PermittedOptionProvider.Argument<Integer> FORCE_PASS = new PermittedOptionProvider.Argument<Integer>(all,
            "recpass", default0intDecoder,
            "Decompile specifically with recovery options from pass #X. (really only useful for debugging)", true);
    public static final PermittedOptionProvider.Argument<AnalysisType> ANALYSE_AS = new PermittedOptionProvider.Argument<AnalysisType>(all,
            "analyseas", new DefaultNullEnumDecoder<AnalysisType>(AnalysisType.class),
            "Force file to be analysed as 'jar' or 'class'");
    public static final PermittedOptionProvider.Argument<String> JAR_FILTER = new PermittedOptionProvider.Argument<String>(all,
    ...
    private static final PermittedOptionProvider.Argument<Boolean> RENAME_MEMBERS = new PermittedOptionProvider.Argument<Boolean>(all,
            "rename", defaultFalseBooleanDecoder,
            "Synonym for 'renamedupmembers' + 'renameillegalidents' + 'renameenumidents'");
    public static final PermittedOptionProvider.Argument<Boolean> RENAME_DUP_MEMBERS = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Integer> RENAME_SMALL_MEMBERS = new PermittedOptionProvider.Argument<Integer>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> RENAME_ILLEGAL_IDENTS = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> RENAME_ENUM_MEMBERS = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Troolean> REMOVE_DEAD_CONDITIONALS = new PermittedOptionProvider.Argument<Troolean>(all,
            "removedeadconditionals", defaultNeitherTrooleanDecoder,
            "Remove code that can't be executed.");
    public static final PermittedOptionProvider.Argument<Troolean> AGGRESSIVE_DO_EXTENSION = new PermittedOptionProvider.Argument<Troolean>(all,
            "aggressivedoextension", defaultNeitherTrooleanDecoder,
            "Fold impossible jumps into do loops with 'first' test");
    public static final PermittedOptionProvider.Argument<Integer> AGGRESSIVE_SIZE_REDUCTION_THRESHOLD = new PermittedOptionProvider.Argument<Integer>(all,
            "aggressivesizethreshold", new DefaultingIntDecoder(15000),
            "Opcode count at which to trigger aggressive reductions");
    public static final PermittedOptionProvider.Argument<Boolean> STATIC_INIT_RETURN = new PermittedOptionProvider.Argument<Boolean>(all,
            "staticinitreturn", defaultTrueBooleanDecoder,
            "Try to remove return from static init");
    public static final PermittedOptionProvider.Argument<Boolean> USE_NAME_TABLE = new PermittedOptionProvider.Argument<Boolean>(all,
            "usenametable", defaultTrueBooleanDecoder,
            "Use local variable name table if present");
    public static final PermittedOptionProvider.Argument<String> METHODNAME = new PermittedOptionProvider.Argument<String>(all,
            "methodname", defaultNullStringDecoder,
            "Name of method to analyse");
    public static final PermittedOptionProvider.Argument<String> EXTRA_CLASS_PATH = new PermittedOptionProvider.Argument<String>(all,
            "extraclasspath", defaultNullStringDecoder,
            "additional class path - classes in this classpath will be used if needed.");
    public static final PermittedOptionProvider.Argument<Boolean> PULL_CODE_CASE = new PermittedOptionProvider.Argument<Boolean>(all,
            "pullcodecase", defaultFalseBooleanDecoder,
            "Pull code into case statements agressively");
    public static final PermittedOptionProvider.Argument<Boolean> ELIDE_SCALA = new PermittedOptionProvider.Argument<Boolean>(all,
            "elidescala", defaultFalseBooleanDecoder,
            "Elide things which aren't helpful in scala output (serialVersionUID, @ScalaSignature)");
    public static final PermittedOptionProvider.Argument<Boolean> USE_SIGNATURES = new PermittedOptionProvider.Argument<Boolean>(all,
            "usesignatures", defaultTrueBooleanDecoder,
            "Use signatures in addition to descriptors (when they are not obviously incorrect)");
    public static final PermittedOptionProvider.Argument<Boolean> CASE_INSENSITIVE_FS_RENAME = new PermittedOptionProvider.Argument<Boolean>(all,
    ...
    public static final PermittedOptionProvider.Argument<Boolean> LOMEM = new PermittedOptionProvider.Argument<Boolean>(all,
            "lomem", defaultFalseBooleanDecoder,
            "Be more agressive about uncaching in order to reduce memory footprint");
    public static final PermittedOptionProvider.Argument<String> IMPORT_FILTER = new PermittedOptionProvider.Argument<String>(all,
    ...
    public static final PermittedOptionProvider.Argument<String> OBFUSCATION_PATH = new PermittedOptionProvider.Argument<String>(all,
